                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class=" mb-3 flex-fill mb-0 fs-6">
                                            ...
                                            <form:select path="roleId" class="form-select">
                                                <form:option  value="${customer.roleId}">Khách hàng</form:option>
                                                <form:option  value="${owner.roleId}">Chủ nhà xe</form:option>
                                            </form:select>
                                        </div>

                                    </div>
                                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                        <button type="submit" class="btn btn-outline-success btn-lg">Đăng ký</button>
                                    </div>
