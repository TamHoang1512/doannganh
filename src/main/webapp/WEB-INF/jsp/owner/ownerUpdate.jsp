<%-- 
    ...
    Created on : Sep 2, 2022, 11:01:32 PM
    Author     : 84344
--%>
...
<div class="container col-6 " style="font-family: 'Time News Ronamce'; background-color: white; ">
    <c:url value="/owner/${u.userId}/own/update/${oId}" var="action" />

    <form:form  method="post" action="${action}" 
                modelAttribute="ownerUpdateV" enctype="multipart/form-data"
                >
        ...
        <div class="form-group col-5">
            <label for="isFreight" class="form-label border-bottom font-weight-bold" style="color:blue">NHẬN GIAO HÀNG:</label>
            <form:select path="isFreight" cssClass="form-select font-weight-bold">
                <option class="font-weight-bold"  value="0">KHÔNG</option>
                <option class="font-weight-bold"  value="1">CÓ</option>
            </form:select>
        </div>
