<%-- 
    Document   : addBusByOwn
    Created on : Aug 29, 2022, 11:59:51 AM
    Author     : 84344
--%>
...
<center><h2>THÊM CHUYẾN XE</h2></center>
...
<div class="container col-6 " style="font-family: 'Time News Ronamce'; background-color: white; ">
    <c:url value="/owner/${uid}/bus/add" var="action" />

    <form:form  method="post" action="${action}" 
                modelAttribute="addNewBus" enctype="multipart/form-data"
                >
