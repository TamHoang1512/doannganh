...
<c:if test="${roleUser==('admin')}" >
    <a href="<c:url value="/admin/news/block" />">Manage Block news</a>
</c:if>
                ...
                <div style="display: flex; justify-content:center;height: 100%" class="col-4 ">
                    ...
                    <div class="btn-group">
                        ...
                        <a style="border: 1px solid green;color:green;" 
                           href="<c:url value="/admin/news/info/${o.id}" />" class="btn btn-mini">VIEW
                        </a>
                        <a style="border: 1px solid green;color:green;" 
                           href="<c:url value="/admin/news/update/${o.id}" />" class="btn btn-mini">EDIT
                        </a>
