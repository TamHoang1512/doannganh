<%-- 
    Document   : stationUpdate
    Created on : Sep 3, 2022, 2:19:49 AM
    Author     : 84344
--%>
...
<div class="container col-6 " style="font-family: 'Time News Ronamce'; background-color: white; ">
    <c:url value="/admin/station/update/${sId}" var="action" />

    <form:form  method="post" action="${action}" 
               modelAttribute="stationUpdate" enctype="multipart/form-data"
               >
